...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        header('Location: license-process-payment.php');
        exit();
    }
}
...
<div class="renewal-container">
    <div class="renewal-header">
        ...
        <h1>License Renewal Payment</h1>
        <p>Complete your driving license renewal payment</p>
    </div>
    ...
    <div class="payment-summary">
        ...
        <div class="summary-item">
            <span>IC Number:</span>
            <strong><?php echo htmlspecialchars($renewal_data['ic_number']); ?></strong>
        </div>
        <div class="summary-item">
            <span>License Number:</span>
            <strong><?php echo htmlspecialchars($renewal_data['license_number']); ?></strong>
        </div>
        <div class="summary-item">
            <span>License Types:</span>
            <strong><?php echo htmlspecialchars($renewal_data['license_types']); ?></strong>
        </div>
        <div class="summary-item">
            <span>Renewal Period:</span>
            <strong><?php echo ucwords(str_replace('_', ' ', $renewal_data['renewal_period'])); ?></strong>
        </div>
        <div class="summary-item">
            <span>State Issued:</span>
            <strong><?php echo htmlspecialchars($renewal_data['state_issued'] ?? 'N/A'); ?></strong>
        </div>
